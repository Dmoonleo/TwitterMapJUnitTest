...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testDeleteBtn() {
		...
		for (int i = 0; ; ++i) {
			...
			while (buttons == null)
				buttons = (LinearLayout) view2.findViewById(R.id.button_group);
			if (buttons.getChildCount() < 5)
				continue;
			else {
	...
	public void testHomeTabRetweetAndFavor() {
